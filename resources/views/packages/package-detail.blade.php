...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
	    ...
	    <div id="docs-sidebar" class="docs-sidebar">
		    ...
		    <nav id="docs-nav" class="docs-nav navbar">
			    <ul class="section-items list-unstyled nav flex-column pb-3">
				    <li class="nav-item section-title"><a class="nav-link scrollto active" href="#masterbase"><span class="theme-icon-holder mr-2"><i class="fas fa-map-signs"></i></span>Masterbase</a></li>
				    <li class="nav-item"><a class="nav-link scrollto" href="#masterbase-1-1">To Do</a></li>					
				    <li class="nav-item"><a class="nav-link scrollto" href="#masterbase-1-1">Open Issues</a></li>
				    <li class="nav-item"><a class="nav-link scrollto" href="#item-1-2">Dependencies</a></li>
				    <li class="nav-item"><a class="nav-link scrollto" href="#item-1-3">Future Plans</a></li>
  ...
  },
  {
    ...
    <span class="hljs-attr">"description"</span>: {<span class="hljs-attr">"text"</span>: <span class="hljs-string">"..."</span>, <span class="hljs-attr">"sensitive"</span>: <span class="hljs-literal">false</span>}
					...
					<section class="docs-section" id="item-1-2">
						...
						<figure class="figure docs-figure py-3">
						    <a href="assets/images/features/appify-theme-projects-overview-lg.jpg" data-title="Image Lightbox Example" data-toggle="lightbox"><img class="figure-img img-fluid shadow rounded" src="" alt="" style="width: 600px;"></a>
    ...
    <script src="/js/light-custom.js"></script> 
